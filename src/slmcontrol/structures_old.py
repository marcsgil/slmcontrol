...
def lg(
    x: ArrayLike, y: ArrayLike, p: int = 0, l: int = 0, w: Union[int, float] = 1
) -> ArrayLike:
...
def hg(
    x: ArrayLike, y: ArrayLike, m: int = 0, n: int = 0, w: Union[int, float] = 1
) -> ArrayLike:
...
def rectangular_aperture(
    x: ArrayLike, y: ArrayLike, a: Union[int, float], b: Union[int, float]
) -> ArrayLike:
...
def double_slit(
    x: ArrayLike, y: ArrayLike, a: Union[int, float], d: Union[int, float]
) -> ArrayLike:
